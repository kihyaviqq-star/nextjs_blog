    ...
    try {
      ...
      if (process.env.OPENROUTER_API_KEY) {
        try {
          ...
          const prompt = `Ты - профессиональный IT-копирайтер. Твоя задача написать SEO-оптимизированный обзор программы ${name} и выделить для нее теги.
...
4. Убедись, что JSON валидный.`;
          ...
          console.log(`  ✅ AI Успешно сгенерировал SEO-текст и теги: ${extractedTags.join(', ')}`);
